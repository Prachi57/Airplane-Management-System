...
public class CancelFlight extends JFrame implements ActionListener{
    ...
    CancelFlight()
    {
        ...
        l1=new JLabel("Cance Your Flight Ticekt");
        ...
        l14.setForeground(new java.awt.Color(103,3,173));
        
        bt1.setBackground(new java.awt.Color(176,4,21));
        bt2.setBackground(Color.BLACK);
        
        bt1.setBackground(Color.WHITE);
        bt2.setBackground(new java.awt.Color(230,225,225));
//        
            ...
            public void mouseClicked(MouseEvent arg0)
            {
                try
                {
                    ...
                    while(rest1.next())
                    {
                        ...
                        tf2.setText(rest1.getString("destiation"));
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
            ...
            try
            {
                ...
                if(aa==1)
                {
                    JOptionPane.showMessageDialog(null,"Your flight has Canceled");
